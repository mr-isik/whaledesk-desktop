...
import {
  GetSetting,
  SaveSetting,
} from "../../wailsjs/go/bindings/SettingsBinding";
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          >
            Choose between WhaleDesk's dark, linear-inspired developer workspace
            or a crisp, high-contrast light mode.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          >
            Used for generating API requests from documentation in the API
            Tester. The key is encrypted before being stored locally in the
            database.
          </p>
        </div>
