import { Activity, Box, Clock, RefreshCw, Terminal } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const containerPercent =
    totalContainers > 0 ? (runningContainers / totalContainers) * 100 : 0;
        ...
        <>
          ...
          >
            ...
            <div className="glass-card" style={{ overflow: "hidden" }}>
              ...
              >
                <span
                  className={`badge ${isDaemonRunning ? "success" : "danger"}`}
                >
            ...
            >
              ...
              >
                {apiLogs.length === 0 ? (
                  ...
                  >
                    No recorded activities. Use API Tester to generate API
                    requests.
                  </div>
                ) : (
                  apiLogs.slice(0, 4).map((log) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span
                            className={`badge ${log.status >= 200 && log.status < 300 ? "success" : "danger"}`}
                            style={{
                              minWidth: "48px",
                              justifyContent: "center",
                            }}
